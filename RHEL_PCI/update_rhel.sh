...
then
        gnome-terminal --working-directory=/home/eldar/script -x bash -c "./RHEL_PCI/update_rhel.exp $connection_user $connection_pass $hostname; bash"
else

	./RHEL_PCI/update_rhel.exp $connection_user $connection_pass $hostname
fi
